# This call is used to house all the common functions for the PC
require "win32ole"
...
class Utility
	...
	def createDir()
		...
		@dirName="C:\\Users\\#{username}\\Desktop\\ReachEdge_BAT_"+Time.now.strftime("%Y%m%d%H%M%S")
	...
	def setUpBrowser(x)
		begin
			if x== 1
				...
				#Internet Explorer browser instantiation
